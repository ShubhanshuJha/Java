...
public class CountSetBits implements Runnable {
	...
	private static int countSetBits4(int n) {
    ...
    private static final void solution() throws IOException {
        ...
        while (test-- > 0) {
            ...
            output.println("Total Set Bits in number is: " + 
            		countSetBits4(num));
        }
        output.close();
        input.close();
    ...
    public static void main(String... args) throws IOException {
        new Thread(null, new CountSetBits(), "Main", 1 << 26).start();
    }
