...
public class SwapOddEvenBits implements Runnable {
    ...
    private static final void solution() throws IOException {
        ...
        while (test-- > 0) {
            ...
            output.println("N = " + n + " {" + Integer.toBinaryString(n)
            		+ "}");
            output.println("After swapping odd and even bits: " +
            		Integer.toBinaryString(swapOddEvenBits(n)));
        }
        output.close();
        input.close();
    }
    ...
    public static void main(String... args) throws IOException {
        new Thread(null, new SwapOddEvenBits(), "Main", 1 << 26).start();
    }
