// Modulous using Bitwise operation is possible if M is a power of 2
import java.io.*;
import java.util.*;
import static java.lang.Math.*;
import static java.lang.System.*;

public class ModuloOfAGivenNumber implements Runnable {
    ...
    private static final void solution() throws IOException {
        ...
        while (test-- > 0) {
            ...
            int m = input.nextInt();
            // N % M
            int mod = n & 0x7; // here m = 8
            output.println("N mod 8 = " + mod);
            mod = mod(n, m);
            output.println("N mod M = " + mod);
        }
        output.close();
        input.close();
    }
    ...
    public static void main(String... args) throws IOException {
        new Thread(null, new ModuloOfAGivenNumber(), "Main", 1 << 26).start();
    }
