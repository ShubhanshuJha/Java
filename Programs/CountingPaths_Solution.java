...
public class CountingPaths_Solution{
...
// Find all the paths in a N*M grid. Condition: You can only move towards right or towards bottom.
// Basically, have to find total number of paths forming in the grid.

// 	Scanner sc = new Scanner(System.in);
// 	System.out.println("Enter the value of N and M for N*M grid:");
// 	int n = sc.nextInt();
// 	int m = sc.nextInt();
// 	System.out.println("Total possible paths = "+ paths(n, m));
